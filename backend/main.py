...
from articleSearch.routes import routeAs as articlesearch_router
...
# Inject the endpont "articlesearch"
app.include_router(articlesearch_router, tags=["Article Search"], prefix="/article")
