...
FICHIER PERMETTANT DE JOUER AVEC LES DONNEES OBTENUES PAR LE REQUETE DU FICHIER "requete_mostpopular.py" ET STOCKE DANS "most_emailed.json".

!!! Si vous n'avez pas de fichier "most_emailed.json". Lancez le fichier "requete_mostpopular.py" pour le créer.
...
with open("most_emailed.json", "r") as rf:
