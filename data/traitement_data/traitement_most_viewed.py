...
FICHIER PERMETTANT DE JOUER AVEC LES DONNEES OBTENUES PAR LE REQUETE DU FICHIER "requete_mostpopular.py" ET STOCKE DANS "most_viewed.json".

!!! Si vous n'avez pas de fichier "most_viewed.json". Lancez le fichier "requete_mostpopular.py" pour le créer.
...
with open("most_viewed.json", "r") as rf:
